...
public class LaboratoryStorage : ILaboratoryStorage
{
    ...
    private const string insertLaboratoryCommand =
        "Insert INTO dbo.LABORATORY (LaboratoryId,Name, Adress,University, Faculty, Department,Acronyme,PhoneNumber,Email,AgrementNumber,CreationDate,Logo,WebSite) " +
    ...
    private const string selectLaboratoryCountByIdQuery = "SELECT COUNT(*) FROM VLABORATORY WHERE Id = @Id";
